    ...
    <div ref={containerRef} className="relative">
      ...
      >
        <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          <motion.div
            className="absolute left-8 top-0 w-[1px] h-full bg-gradient-to-t from-blue-500 via-blue-500 to-transparent from-[0%] via-[10%] rounded-full"
            style={{
            ...
            >
              <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black flex items-center justify-center">
                  <div className="h-4 w-4 rounded-full bg-blue-600 border border-blue-600 p-2" />
                </div>
